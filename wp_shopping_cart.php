...
function print_wp_shopping_cart()
{
    ...
    {
    	$output .= "<input type='image' src='".WP_CART_URL."/images/shopping_cart_icon1.png' value='Cart' title='Cart' />";
    }
    if(!empty($title))
    {
    	$output .= '<h2>';
    ...
    foreach ($_SESSION['simpleCart'] as $item)
    {
        ...
        <input type='image' src='".WP_CART_URL."/images/Shoppingcart_delete1.png' value='Remove' title='Remove' /></form></td></tr>
